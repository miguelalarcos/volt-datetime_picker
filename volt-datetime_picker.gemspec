...
require 'volt/datetime_picker/version'

Gem::Specification.new do |spec|
  spec.name          = "volt-datetime_picker"
  spec.version       = Volt::DatetimePicker::VERSION
  spec.authors       = ["miguel"]
  spec.email         = ["miguel.alarcos@gmail.com"]
  spec.summary       = %q{A datetime picker for the Ruby framework Volt.}
  spec.description   = %q{A datetime picker for the Ruby framework Volt.}
  spec.homepage      = ""
  spec.license       = "MIT"
